...
const Home = () => {
  ...
  return (
    <ScrollView style={{backgroundColor: '#000'}} blurRadius={100}>
        ...
        <View style={styles.carouselContentContainer}>
          <View style={{...StyleSheet.absoluteFill, backgroundColor: '#000'}}>
            ...
            <Text style={{color: 'white', fontSize: 24, fontWeight: 'bold', marginLeft: 10, marginVertical:     10 }}>Films disponibles</Text>
    ...
    <View style={{marginHorizontal: 14}}>
        <Text style={{color: 'white', fontSize: 24, fontWeight: 'bold',marginBottom: 24}}> </Text>
        <ImageBackground
        ...
        <Text style={{color: 'white', fontSize: 24, fontWeight: 'bold',}}>Favoris</Text>
        <Text style={{color: '#02ad94', fontSize: 14, fontWeight: 'normal'}}>Voir tous</Text>
        </View>
